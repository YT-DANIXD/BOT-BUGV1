...
🌷 KALAU MAU RENAME TARO CREDITS GUA : 𝑳𝑰𝑿𝑿𝒁𝒀 𝐌𝚫𝐊𝚵𝐑 䄀 */
...
he = `𝑺𝑬𝑳𝑨𝑴𝑨𝑻 𝑫𝑨𝑻𝑨𝑵𝑮 : @${num.split("@")[0]}\n\n${metadata.desc}`
let link = `https://saweria.co/LixxzyNewbie`
let buttons = [
{buttonId: `𝑳𝑰𝑿𝑿𝒁𝒀 𝐌𝚫𝐊𝚵𝐑 䄀`, buttonText: {displayText: buttonvirus}, type: 1},
]
let buttonMessage = {
...
mentions: [num],
fileName: `𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝑮𝑹𝑶𝑼𝑷 : ${metadata.subject}`,
fileLength: 99999999999999,
caption: he,
footer: `© 𝑳𝑰𝑿𝑿𝒁𝒀 𝐌𝚫𝐊𝚵𝐑 䄀`,
buttons: buttons,
headerType: 4,
contextInfo:{externalAdReply:{
title: `𝑺𝑬𝑳𝑨𝑴𝑨𝑻 𝑩𝑬𝑹𝑮𝑨𝑩𝑼𝑵𝑮️`,
body: `© 𝑳𝑰𝑿𝑿𝒁𝒀 𝐌𝚫𝐊𝚵𝐑 䄀`,
mediaType:2,
thumbnail: buffer,
sourceUrl: link,
...
jpegThumbnail:buffer,
mentions: [num],
fileName: `𝑳𝑬𝑨𝑽𝑬 𝑭𝑹𝑶𝑴 𝑮𝑹𝑶𝑼𝑷 : ${metadata.subject}`,
fileLength: 99999999999999,
caption: he,
footer: `© 𝑳𝑰𝑿𝑿𝒁𝒀 𝐌𝚫𝐊𝚵𝐑 䄀`,
buttons: buttons,
